...
//   },
 ...
 { KC_LCTL, KC_LGUI,  MO(_FN), KC_LALT, LT(_FN, KC_SPC), KC_SPC, KC_LEFT, KC_DOWN, KC_RGHT, LT(_FN, KC_ENT), LT(_FN, KC_ENT), MO(_FN), KC_RALT, KC_RGUI, KC_RCTL },
 },
 ...
 */
 [_FN] = { /* FUNCTION */
  ...
  {KC_CAPS, _______, _______, KC_LCBR, KC_RCBR, KC_PLUS, _______, _______, _______, _______, _______, KC_HOME, KC_END, _______, _______},
